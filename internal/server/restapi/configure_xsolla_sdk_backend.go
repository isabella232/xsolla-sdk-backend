...
//go:generate swagger generate server --target ../../server --name XsollaSdkBackend --spec ../../../api/flatten_swagger.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.XsollaSdkBackendAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.XsollaSdkBackendAPI) http.Handler {
	...
	if api.HealthcheckHealthcheckHandler == nil {
